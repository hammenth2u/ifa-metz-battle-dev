...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark booking">
      <span class="m-3 mb-2 mt-2">
        <a href="<?=$_SERVER['BASE_URI']?>/" aria-label="Booking.com r&eacute;servations d&#39;h&ocirc;tels en ligne">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?=$_SERVER['BASE_URI']?>/game">Jeu</a>
            </li>
            <li class="nav-item">
              <a href="<?=$_SERVER['BASE_URI']?>/#contact" class="nav-link" >Contact</a>
            </li>
          </ul>
        </div>
      </div>
